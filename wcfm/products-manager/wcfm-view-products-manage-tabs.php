...
?>
				...
				?>
				<!-- collapsible 6 -->
				<div class="page_collapsible products_manage_attribute <?php echo $wcfm_pm_block_class_stock . ' ' . $wcfm_wpml_edit_disable_element; ?>  <?php echo $wcfm_pm_block_class_attributes; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_attributes', '' ); ?>" id="wcfm_products_manage_form_attribute_head"><label class="wcfmfa fa-server"></label><?php _e('Attributes', 'wc-frontend-manager'); ?><span></span></div>
				<div class="wcfm-container <?php echo $wcfm_pm_block_class_stock . ' ' . $wcfm_wpml_edit_disable_element; ?> <?php echo $wcfm_pm_block_class_attributes; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_attributes', '' ); ?>">
					<div id="wcfm_products_manage_form_attribute_expander" class="wcfm-content">
					  <?php do_action( 'wcfm_products_manage_attributes_start', $product_id, $product_type ); ?>
						...
						?>
						<p class="ethio-notice-message"><?php _e( 'Please select at list two attributes.', 'wc-frontend-manager' ); ?></p>
				...
				<!-- collapsible 1 -->
				<div class="page_collapsible products_manage_inventory <?php echo $wcfm_pm_block_class_attributes; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_attributes', '' ); ?> <?php //echo $wcfm_pm_block_class_stock . ' ' . $wcfm_wpml_edit_disable_element; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_stock', '' ); ?>" id="wcfm_products_manage_form_inventory_head"><label class="wcfmfa fa-database"></label><?php _e('Inventory', 'wc-frontend-manager'); ?><span></span></div>
