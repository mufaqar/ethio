...
jQuery( document ).ready(function() {
	jQuery('.wcfm_submit_button').click(function(){
		jQuery('#frequency_types option[value="daily"]').attr('selected','selected');
...
$frequency_types =  apply_filters( 'wcfm_frequency_types', array('once'  => __('Once', 'wc-frontend-manager'), 'daily' => __('Daily', 'wc-frontend-manager'),  'weekly' => __('Weekly', 'wc-frontend-manager'), 'monthly' => __('Monthly', 'wc-frontend-manager'), 'every3months' => __('Every Three Months', 'wc-frontend-manager'), 'every6months' => __('Every Six Months', 'wc-frontend-manager'), 'annual' => __('Annual', 'wc-frontend-manager') ) );
$duration_postings =  apply_filters( 'wcfm_duration_posting', array('3months'  => __('3 Months', 'wc-frontend-manager'), '6months' => __('6 Months', 'wc-frontend-manager'),  '9 months' => __('9 Months', 'wc-frontend-manager'), '12months' => __('12 Months', 'wc-frontend-manager') ) );
  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<?php
			if( $product_id ) {
				  $frequency_type = get_post_meta( $wcfm_products_single->ID, 'frequency_types', true );
				  $duration_posting = get_post_meta( $wcfm_products_single->ID, 'duration_postings', true );
				?>
				...
				<div id="wcfm_products_manage_form_general_expander" class="wcfm-content">
				  <div class="wcfm_product_manager_general_fields">
				    <?php do_action( 'wcfm_product_manager_left_panel_before', $product_id ); ?>
						...
						<div class="wcfm_clearfix" style="margin-top:20px;"></div>
						<div class="ethio-product-payment-wrap">
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_pricing', array(
								...
								"frequency_types" => array('label' => __('Frequency of payment', 'wc-frontend-manager'), 'type' => 'select', 'options' => $frequency_types, 'class' => 'wcfm-select wcfm_full_ele', 'label_class' => '', 'value' => $frequency_type ),
								"duration_postings" => array('label' => __('Duration of Posting', 'wc-frontend-manager'), 'type' => 'select', 'options' => $duration_postings, 'class' => 'wcfm-select wcfm_full_ele', 'label_class' => '', 'value' => $duration_posting ),
							), $product_id, $product_type, $wcfm_is_translated_product, $wcfm_wpml_edit_disable_element ) );
						?>
						</div>
