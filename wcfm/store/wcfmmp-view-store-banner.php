  ...
  <div class="wcfm_banner_area_desktop">
						...
						<?php if( !empty( $banner_slider['image'] ) ) { ?>
							<div class="wcfmSlides wcfm_slide_fade">
								<a href="<?php echo $banner_slider['link'] ? $banner_slider['link'] : wcfm_get_attachment_url($banner_slider['image']); ?>" target="_blank">
									...
									<img src="<?php echo esc_url(wcfm_get_attachment_url($banner_slider['image'])); ?>" style="width:100%" alt="<?php echo $store_info['store_name']; ?>" title="<?php echo $store_info['store_name']; ?>">
		...
		<?php } else { ?>
			<section class="banner_area banner_area_desktop">
				...
				<div class="banner_img"><img src="<?php echo esc_url($banner); ?>" alt="<?php echo $store_info['store_name']; ?>" title="<?php echo $store_info['store_name']; ?>" /></div>
			...
			<section class="banner_area banner_area_mobile">
				...
				<div class="banner_img"><img src="<?php echo esc_url($mobile_banner); ?>" alt="<?php echo $store_info['store_name']; ?>" title="<?php echo $store_info['store_name']; ?>" /></div>
