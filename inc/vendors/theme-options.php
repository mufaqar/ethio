		...
		$fields = array_merge(
			$fields, array(
				'wcfm_dashboard_custom_fields'      => array(
					...
					'default'  => array( 'video', '360', 'fbt', 'product_cust_location','product_adv_location' ),
					'section'  => 'vendor_dashboard',
					'priority' => 100,
					'choices'  => array(
						...
						'product_cust_location'   => esc_html__( 'Product Location', 'martfury' ),
						'product_adv_location'   => esc_html__( 'Product Advertisement Location', 'martfury' ),
					),
				),
				// Other Catlog
