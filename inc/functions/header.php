...
if ( ! function_exists( 'martfury_header_bar' ) ) :
	function martfury_header_bar() {
		...
		?>
			...
			<?php
				if ( is_user_logged_in() ) {
					...
					if ( in_array( 'wcfm_vendor', (array) $user->roles ) ) {
						...
						?>		<div id="block-4" class="widget widget_block"><p><a href="<?php echo home_url('/'); ?>dashboard/"><?php _e('Vendor Dashboard','martfury'); ?></a></p></div> <?php
					}
					else {
							 if ( !in_array( 'administrator', (array) $user->roles ) ) {
					
						?>		<div id="block-4" class="widget widget_block"><p><a href="<?php echo home_url('/'); ?>become-a-vendor/"><?php _e('Advertise for Free','martfury'); ?></a></p></div> <?php

							 }
					}
					if ( in_array( 'administrator', (array) $user->roles ) ) {
					?>
						<div id="block-4" class="widget widget_block"><p><a href="<?php echo home_url('/'); ?>dashboard/"><?php _e('Admin Dashboard','martfury'); ?></a></p></div>					
					<?php
					
					}
					
				} else {
					?>		<div id="block-4" class="widget widget_block"><p><a href="<?php echo home_url('/');  ?>my-account/"><?php _e('Advertise for Free','martfury'); ?></a></p></div><?php
				}
			?>
			...
			<?php
				if ( is_user_logged_in() ) {
					?>	<div id="block-5" class="widget widget_block"><p><a href="<?php echo home_url('/'); ?>my-account/"><?php _e('My Account','martfury'); ?></a></p></div> <?php
				} else {
					?>	<div id="block-5" class="widget widget_block"><p><a href="<?php echo home_url('/');  ?>my-account/"><?php _e('Login / Signup','martfury'); ?></a></p></div> <?php
				}
				?>
					
					<div id="block-6" class="widget widget_block"><div id="lang_sel">
