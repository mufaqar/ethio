            ...
            <div class="header-extras col-lg-8 col-md-9 col-sm-6 col-xs-6">
                ...
                <ul class="extras-menu">
					...
					if( is_shop() || is_product_category() ){
						echo sprintf( '<li class="extra-menu-item menu-custom-sidebar-filter tablate"><a href="javascript:void(0)" id="menu-custom-sidebar-filter" class="navigation-mobile-sidebar-filter"><i class="icon-equalizer"></i></a></li>', esc_html( '' ) );
					}
					?>
                </ul>
            </div>
